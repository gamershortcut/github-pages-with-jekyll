        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="800">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Kodi is a free and open-source media player software application developed by the
                XBMC Foundation, a non-profit technology consortium.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9N1W7J1RPF7N"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#kodi" class="col-md-5 btn btn-success">Guide</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="games py-4">
    <div class="container" id="game">
      ...
      <div class="row">
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            <img class="card-img-top" src="./img//soniccd.png" alt="VVVVVV">
            <div class="card-body">
              <h5 class="card-title">Sonic CD</h5>
              <p class="card-text">A port based on the decompilation of Sonic CD</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9P84MTD1S537"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="800">
          <div class="card text-center">
            <img class="card-img-top" src="./img/sonic1.jpg" alt="am2r">
            <div class="card-body">
              <h5 class="card-title">Sonic 1</h5>
              <p class="card-text">This is a Sonic 1 decompilation project of the mobile ports from Christian Whitehead
                with native 16:9 support and QoL fixes.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9NB6J7N8L2HL"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            <img class="card-img-top" src="./img/sonic2.jpg" alt="Openlara">
            <div class="card-body">
              <h5 class="card-title">Sonic 2</h5>
              <p class="card-text">This is a Sonic 2 decompilation project of the mobile ports from Christian Whitehead
                with native 16:9 support and QoL fixes.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9N6SR7MS301V"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            ...
            <div class="card-body">
              <h5 class="card-title">OpenLara</h5>
              <p class="card-text">An open source port of the classic Tomb Raider engine.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9PGPMWTXPS38"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9NDN5QVM742S"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#am2r" class="col-md-5 btn btn-success disabled">Guide</a>
              </div>
            </div>
          </div>
        </div>
	...
	<div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            <img class="card-img-top" src="./img/hode.jpg" alt="Heart of Darkness">
            <div class="card-body">
              <h5 class="card-title">Heart of Darkness</h5>
              <p class="card-text">Heart of Darkness retail port based on the decompilation project.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9NQTZFFC31XN"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#am2r" class="col-md-5 btn btn-success disabled">Guide</a>
              </div>
	...
	<div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            <img class="card-img-top" src="./img/VVVVVV.jpg" alt="VVVVVV">
            <div class="card-body">
              <h5 class="card-title">VVVVVV</h5>
              <p class="card-text">VVVVVV is a platform game all about exploring one simple mechanical idea - what if you reversed gravity instead of jumping?</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9MT1QR12N5H6"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#am2r" class="col-md-5 btn btn-success disabled">Guide</a>
              </div>
	...
	<div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            <img class="card-img-top" src="./img/Pac-Man.jpg" alt="Pac-Man">
            <div class="card-body">
              <h5 class="card-title">Pac-Man</h5>
              <p class="card-text">Pac-Man is a classic arcade game.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9NB7JX5H7FRP"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#am2r" class="col-md-5 btn btn-success disabled">Guide</a>
              </div>
	...
	<div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            <img class="card-img-top" src="./img/MsPac-Man.jpg" alt="Pac-Man">
            <div class="card-body">
              <h5 class="card-title">Ms.Pac-Man</h5>
              <p class="card-text">Ms.Pac-Man is a classic arcade game.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9ND7024PWBSN"
                  class="col-md-5 mb-md-0 mb-3 btn btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#am2r" class="col-md-5 btn btn-success disabled">Guide</a>
              </div>
